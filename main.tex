...
\begin{figure}[h]
  ...
  \caption{Models of neural data aim to connect observed neural activity with other variables of interest, but must do so while contending with numerous known and unknown factors that also modulate neural activity.}
