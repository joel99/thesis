...
\newcommand{\committee}{
  \begin{center}
    \scsurname{Robert}{Gaunt}[({co-chair})] \\
    \scsurname{Leila}{Wehbe}[({co-chair})] \\
    \scsurname{Jennifer}{Collinger} \\
    \scsurname{Aran}{Nayebi} \\
...
\begin{titlepage}
  ...
  \vfill
  \vspace{2em}
  {\small \textit{Submitted in partial fulfillment of the requirements for the Degree of Doctor of Philosophy}\par}
\end{titlepage}
